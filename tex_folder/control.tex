...
\item A lei de controle considera os erros $\mathbf{e}_{\positionVector}=\positionVector-\positionVector_{s}$, $\mathbf{e}_{velocityVector}_v=\velocityVector-\velocityVector_{s}$ e $\mathbf{e}_{\accelerationVector}=\accelerationVector-\accelerationVector_{s}$
\end{enumerate}
